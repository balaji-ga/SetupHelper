...
namespace clawSoft.clawPDF.SetupHelper.Driver
{
    public class clawPDFInstaller
    {
        ...
        private const string PRINTERNAME = "ParchiPDF";
        private const string DRIVERNAME = "Parchi Virtual Printer";
        private const string HARDWAREID = "Parchi_Driver";
        ...
        private const string DRIVERMANUFACTURER = "Parchi";
